...
<div class="row">
	<div class="col-12">
		<div class="card no-export">
			<div class="card-body">
			 <h4 class="card-title">
				<span class="panel-title">{{ _lang('Accounting Approval Data Klaim') }}</span>
			 </h4>
			 <table class="table table-bordered data-table">
				...
				<tbody>
				  ...
				  <tr id="row_{{ $claim->id }}">
					...
					@if(empty($claim->appz->status_finance))
						@if(empty($claim->approval->status_terima_acc))
					    ...
					    <div class="dropdown">
						  ...
						  {{ _lang('Action') }}
							...
							<div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
								<a href="{{ action('ApprovalController@apvfat', $claim['id']) }}" class="dropdown-item"><i class="mdi mdi-eye"></i> {{ _lang('View') }}</a>	
							</div>
						</div>
					</td>
				  </tr>
