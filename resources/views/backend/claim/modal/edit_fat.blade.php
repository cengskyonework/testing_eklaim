<form method="post" class="ajax-submit" autocomplete="off" action="{{ route('claim.simpan_fat', $id) }}" enctype="multipart/form-data">
	{{ csrf_field()}}
	...
	@foreach($appx as $app)
		<div class="col-md-12">
		 <div class="form-group">
			...
			<input type="text" class="form-control datepicker" name="tanggal_kirim_fat" value="{{ $app->tanggal_kirim_fat }}" readonly>
		 </div>
		</div>
	@endforeach		
