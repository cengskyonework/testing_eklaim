        ...
        <div class="container-fluid page-body-wrapper">
            ...
            <nav class="sidebar sidebar-offcanvas" id="sidebar">
                <ul class="nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" data-toggle="collapse" href="#costcenter" aria-expanded="false" aria-controls="ui-basic">
                        ...
                        <div class="collapse" id="costcenter">
                            <ul class="nav flex-column sub-menu">
                                <li class="nav-item">
                                    <a class="nav-link" href="{{ url('costcenter') }}">{{ _lang('Cost Center') }}</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="{{ url('channel') }}">{{ _lang('Deskripsi Cost Center') }}</a>
                                </li>
                            </ul>
                        </div>
                    </li>
                    <li class="nav-item">
                        ...
                        <div class="collapse" id="property-management">
                            <ul class="nav flex-column sub-menu">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" href="{{ url('category') }}">{{ _lang('Jenis Klaim') }}</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="{{ url('distributor') }}">{{ _lang('Distributor') }}</a>
                                </li>
                                <li class="nav-item">
                    ...
                    <li class="nav-item">
                        ...
                        <div class="collapse" id="agent-management">
                            <ul class="nav flex-column sub-menu">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" href="{{ url('createx') }}">{{ _lang('Form Klaim') }}</a>
                                </li>
                                @endif
                                <li class="nav-item">
                        ...
                        <div class="collapse" id="blog-management">
                            <ul class="nav flex-column sub-menu">
                                <li class="nav-item">
                                    ...
                                    <a class="nav-link" href="{{ url('approval') }}">{{ _lang('Approval') }}</a>
                                    @endif
                                    @if (Auth::user()->user_type == 'admin' || Auth::user()->user_type == 'accounting')
                                    <a class="nav-link" href="{{ url('finance_approval') }}">{{ _lang('Accounting Approval') }}</a>
                                    @endif
                                    @if (Auth::user()->user_type == 'admin' || Auth::user()->user_type == 'finance')
                                    <a class="nav-link" href="{{ url('acc_approval') }}">{{ _lang('Finance Approval') }}</a>
                                    <a class="nav-link" href="{{ url('bulkpembayaran') }}">{{ _lang('Bulk Pembayaran') }}</a>
                                    @endif
                                </li>
                            </ul>
                        </div>
                    ...
                    <li class="nav-item">
                        <a class="nav-link" data-toggle="collapse" href="#report-management" aria-expanded="false" aria-controls="ui-basic">
                        ...
                        <div class="collapse" id="report-management">
                            <ul class="nav flex-column sub-menu">
                                <li class="nav-item">
                                    <a class="nav-link" href="{{ url('reports') }}">{{ _lang('Claim Reports') }}</a>
                                </li>
                            </ul>
                        </div>
                    </li>
                    ...
                    <li class="nav-item">
                        ...
                        <div class="collapse" id="user-management">
                            <ul class="nav flex-column sub-menu">
                                <li class="nav-item">
                                    <a class="nav-link" href="{{ url('users') }}">{{ _lang('User Management') }}</a>
                                </li>
                            </ul>
                        </div>
                    </li>
